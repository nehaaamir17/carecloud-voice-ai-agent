...
| Deployment accessible at review                  | Railway public gateway backed by the deployed Worker and D1; protected patient API on public origin   | Railway health, session, API, persisted call and booking checks passed |
